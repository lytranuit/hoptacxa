! function(t) {
    ...
    ! function(s) { o = [i(16)], n = s, r = "function" == typeof n ? n.apply(e, o) : n, !(void 0 !== r && (t.exports = r)) }(function(t) {
        ...
        var D, L = "ajax",
            M = function() { D && t(document.body).removeClass(D) },
            z = function() { M(), e.req && e.req.abort() };
        t.magnificPopup.registerModule(L, {
            options: { settings: null, cursor: "mfp-ajax-cur", tError: '<a href="%url%">The content</a> could not be loaded.' },
            proto: {
                initAjax: function() { e.types.push(L), D = e.st.ajax.cursor, S(a + "." + L, z), S("BeforeChange." + L, z) },
                getAjax: function(i) {
                    ...
                    var n = t.extend({
                        ...
                        success: function(n, o, r) {
                            var s = { data: n, xhr: r };
                            k("ParseAjax", s), e.appendContent(t(s.data), L), i.finished = !0, M(), e._setFocus(), setTimeout(function() { e.wrap.addClass(g) }, 16), e.updateStatus("ready"), k("AjaxContentAdded")
                        },
    ...
    ! function(t, e, i) {
        ...
        n.prototype = {
            ...
            reposition: function() {
                ...
                function n(i, n) { a.offset.top - t(e).scrollTop() - c - A - 12 < 0 && n.indexOf("top") > -1 && (D = i), a.offset.top + a.dimension.height + c + 12 + A > t(e).scrollTop() + t(e).height() && n.indexOf("bottom") > -1 && (D = i, I = a.offset.top - c - A - 12) }
                var o = this;
    ...
    t.exports = function(t, e, i, y, b, w, x) {
        ...
        if (D && (k = d(D.call(new t)), k !== Object.prototype && k.next && (u(k, T, !0), n || a(k, h) || s(k, h, v))), P && I && I.name !== g && (_ = !0, A = function() { return I.call(this) }), n && !x || !p && !_ && j[h] || s(j, h, A), l[e] = A, l[T] = v, b)
    ...
    var n = i(35),
        ...
        R = function(t) { var e = F[t] = S(I[D]); return e._k = t, e },
        q = B && "symbol" == typeof I.iterator ? function(t) { return "symbol" == typeof t } : function(t) { return t instanceof I },
        U = function(t, e, i) { return t === N && U(W, e, i), y(t), e = w(e, !0), y(i), o(F, e) ? (i.enumerable ? (o(t, L) && t[L][e] && (t[L][e] = !1), i = S(i, { enumerable: x(0, !1) })) : (o(t, L) || _(t, L, x(1, {})), t[L][e] = !0), V(t, e, i)) : _(t, e, i) },
        ...
        X = function(t) { var e = z.call(this, t = w(t, !0)); return !(this === N && o(F, t) && !o(W, t)) && (!(e || !o(this, t) || !o(F, t) || o(this, L) && this[L][t]) || e) },
        K = function(t, e) { if (t = b(t), e = w(e, !0), t !== N || !o(F, e) || o(W, e)) { var i = P(t, e); return !i || !o(F, e) || o(t, L) && t[L][e] || (i.enumerable = !0), i } },
        Z = function(t) { for (var e, i = j(b(t)), n = [], r = 0; i.length > r;) o(F, e = i[r++]) || e == L || e == l || n.push(e); return n },
        J = function(t) { for (var e, i = t === N, n = j(i ? W : b(t)), r = [], s = 0; n.length > s;) !o(F, e = n[s++]) || i && !o(N, e) || r.push(F[e]); return r };
    B || (I = function() {
        if (this instanceof I) throw TypeError("Symbol is not a constructor!");
        var t = h(arguments.length > 0 ? arguments[0] : void 0),
            e = function(i) { this === N && e.call(W, i), o(this, L) && o(this[L], t) && (this[L][t] = !1), V(this, t, x(1, i)) };
        return r && $ && V(N, t, { configurable: !0, set: e }), R(t)
    }, a(I[D], "toString", function() { return this._k }), k.f = K, E.f = U, i(87).f = C.f = Z, i(84).f = X, i(83).f = J, r && !i(33) && a(N, "propertyIsEnumerable", X, !0), f.f = function(t) { return R(p(t)) }), s(s.G + s.W + s.F * !B, { Symbol: I });
    for (var tt = "hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), et = 0; tt.length > et;) p(tt[et++]);
    for (var it = T(p.store), nt = 0; it.length > nt;) m(it[nt++]);
    s(s.S + s.F * !B, "Symbol", {
        for: function(t) { return o(Q, t += "") ? Q[t] : Q[t] = I(t) },
        keyFor: function(t) {
    ...
    Flatsome.behavior("toggle", {
        attach: function(t) {
            jQuery(".widget ul.children, .nav ul.children, .menu .sub-menu", t).each(function() { jQuery(this).parent().addClass("has-child").attr("aria-expanded", "false"), jQuery(this).before('<button class="toggle"><i class="fas fa-angle-down"></i></button>') }), jQuery(".current-cat-parent", t).addClass("active").attr("aria-expanded", "true").removeClass("current-cat-parent"), jQuery(".toggle", t).click(function(t) {
                var e = jQuery(this);
