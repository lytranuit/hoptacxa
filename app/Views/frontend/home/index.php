...
<div id="content" role="main" class="content-area">
    ...
    <section class="section" id="section_1405786062">
        ...
        <div class="section-content relative">
            ...
            <div class="row" id="row-1347723925">
    ...
    <section class="section dark has-parallax" id="section_191242925">
            ...
            <div class="row row-small align-middle" id="row-439060445">
                        ...
                        <div class="banner has-hover" id="banner-1381202860">
                            <div class="banner-inner fill">
                                <div class="banner-bg fill">
                                    ...
                                    <div class="is-border is-dotted" style="border-color:rgb(71, 69, 69);border-radius:10px;border-width:2px 2px 2px 2px;margin:5px 5px 5px 5px;">
                                    </div>
                                </div>
                                <!-- bg-layers -->
                                <div class="banner-layers container">
                ...
                <div class="col medium-3 small-12 large-3">
                    <div class="col-inner">
                        ...
                        <div class="banner has-hover" id="banner-311232783">
                            <div class="banner-inner fill">
                                <div class="banner-bg fill">
                                    <div class="bg fill bg-fill  bg-loaded"></div>
                ...
                <div class="col medium-3 small-12 large-3">
                    <div class="col-inner">
                        ...
                        <div class="banner has-hover" id="banner-1799536947">
                            <div class="banner-inner fill">
                                <div class="banner-bg fill">
                                    <div class="bg fill bg-fill  bg-loaded"></div>
                ...
                <div class="col medium-3 small-12 large-3">
                    <div class="col-inner">
                        ...
                        <div class="banner has-hover" id="banner-119692359">
                            <div class="banner-inner fill">
                                <div class="banner-bg fill">
                                    <div class="bg fill bg-fill  bg-loaded"></div>
        ...
        <style scope="scope">
            ...
            #section_191242925 .section-bg-overlay {
    ...
    <section class="section dark has-parallax" id="section_1585802830">
        <div class="bg section-bg fill bg-fill parallax-active bg-loaded">
        ...
        <div class="section-content relative">
            ...
            <div class="row" id="row-1296653687">
                ...
                <div class="col medium-6 small-12 large-6">
                    <div class="col-inner" style="margin:0px 0px -50px 0px;">
                        ...
                        <!-- .divider -->
                        <div class="gap-element clearfix hide-for-medium" style="display:block; height:auto; padding-top:20px"></div>

                        <div class="banner has-hover" id="banner-739192939">
                            <div class="banner-inner fill">
                                <div class="banner-bg fill">
                                    <div class="bg fill bg-fill  bg-loaded"></div>
                                ...
                                <div class="banner-layers container">
                                    <div class="fill banner-link"></div>
                                    <div id="text-box-500230747" class="text-box banner-layer x50 md-x50 lg-x50 y50 md-y50 lg-y50 res-text">
                                        <div class="text dark">
        ...
        <style scope="scope">
            ...
            #section_1585802830 .section-bg-overlay {
