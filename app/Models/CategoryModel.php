...
class CategoryModel extends Model
{
    ...
    protected $allowedFields = ['slug', 'name_vi', 'name_en', 'name_jp', 'description_vi', 'description_en', 'description_jp', 'content_vi', 'content_en', 'content_jp', 'date', 'user_id', 'image_id'];
